    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.grid}>
          ...
          <h1>Terms of Service for a Canadian Website Following PIPEDA:</h1>
          <p>
          ...
          <ol>
            <li>
              <strong>Personal Information:</strong> We are committed to
              protecting your privacy and personal information. We comply with
              the Personal Information Protection and Electronic Documents Act
              (PIPEDA) and any other applicable privacy laws. We collect only
              the personal information that is necessary for us to respond to
              your inquiries and to provide you with the best possible service.
              We do not share your personal information with third parties
              unless required by law.
            </li>
            <li>
              <strong>Use of Cookies:</strong> Our website uses cookies to
              provide you with a better browsing experience. Cookies are small
              text files that are stored on your device when you visit our
              website. They help us to improve our website and to provide you
              with personalized content. You can disable cookies in your browser
              settings if you do not want us to use them.
            </li>
            <li>
              <strong>Product Information:</strong> We make every effort to
              provide accurate and up-to-date information about our products on
              our website. However, we make no warranties or representations
              about the accuracy, reliability, or completeness of any
              information on our website.
            </li>
            <li>
              <strong>Intellectual Property:</strong> All content on our
              website, including text, images, and logos, is the property of our
              company and is protected by copyright laws. You may not use any
              content from our website without our prior written consent.
            </li>
            <li>
              <strong>Disclaimer of Liability:</strong> We are not liable for
              any damages or losses that may arise from your use of our website.
              We do not guarantee that our website will be free from errors,
              viruses, or other harmful components.
            </li>
            <li>
              <strong>Changes to these Terms:</strong> We reserve the right to
              modify these terms of service at any time. Any changes will be
              posted on our website, and your continued use of our website after
              any such changes will constitute your acceptance of the revised
              terms.
            </li>
          </ol>
          <p>
