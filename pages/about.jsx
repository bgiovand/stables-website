      ...
      <main className="max-w-max min-w-full md:max-w-lg">
        <section className="bg-stablesBlue pb-0 mb-20">
          <div className="bg-stablesYellow pb-0 mb-20">
            <h2 className="text-7xl text-stablesOrange text-center font-semibold  mt-20 mb-2 pt-20">
              Built by Coneisseurs
            </h2>
            <h2 className="text-stablesBrown text-4xl  text-center font-light  mt-5 mb-2 z-2">
              Our Team
            </h2>
            <Image
            ...
            {team.map((principal) => (
              ...
              >
                <Image
                  ...
                  height={200}
                />
                <h3 className="text-stablesOrange text-2xl font-semibold mt-5">
                  {principal.name}
                </h3>
                <h4 className="text-stablesBrown text-xl font-light mt-2">
                  {principal.title}
                </h4>
                <p className="text-stablesBrown text-lg font-light mt-2">
                  {principal.bio}
                </p>
              </div>
            ))}
        ...
        <section className="flex flex-col items-center justify-center bg-stablesBlue p-10 text-stablesBrown">
          <h1 className="text-stablesOrange text-7xl  text-center font-light mt-20 mb-5 sr-only">
            {about.title}
          </h1>

          <p className="font-med text-4xl mx-72 leading-normal">
            {about.intro}
          </p>
        </section>

        <section id="values" className="mb-20">
          <h2 className="text-stablesOrange text-5xl  text-center font-normal  mt-20 mb-10">
            Values
          </h2>
          <div className="flex flex-col md:flex-row">
            {values.map((value) => (
          ...
          <div className="">
            <div className="flex flex-col">
              <p className="font-semibold text-2xl">
                Everyone says they have the best slow burn cones but, is it
                really true if said quality isn’t consistent. With our expertise
                in manufacturing we can assure you that our quality is the most
                consistent.
              </p>
              <p className="font-light text-2xl">
                Universal compatibility with automation equipment. We’ve done
                rigorous testing on the most common equipment to make sure
                there’s no disruption to your product lines.
              </p>
            </div>
            ...
            <div className="mx-auto">
              <ul className="flex flex-col md:flex-row">
                {certifications.map((cert) => (
                  <li
                    key={cert.name}
                    className="flex flex-col items-center m-5 flex-1 justify-top text-center"
                  >
                    {/* {cert.type} */}
                    <svg
                      data-name="ISO"
                    ...
                    <div className="text-2xl font-semibold text-gray-100 px-3">
                      {cert.name}
                    </div>
                  </li>
                ))}
                ...
                >
                  <div className="flex flex-col w-full">
                    ...
                    >
                      ...
                      />
                      <span className="text-gray-100 sr-only">
                        {brand.name}
                      </span>
                    </Link>
