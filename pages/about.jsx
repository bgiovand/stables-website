        ...
        <section id="values" className="mb-20">
          ...
          <div className="">
            ...
            <div className="flex w-max">
              <ul className="font-light text-2xl flex flex-row md:flex-row justify-items-center">
            ...
            <ul className="font-light flex flex-col md:flex-row">
              {compatibility.map((brand) => (
                <li
                  key={brand.name}
                  className="flex flex-col items-center justify-center m-5"
                >
                  <div className="text-stablesYellow text-2xl font-semibold  align-top">
                    <Link
                      href={brand.link}
                      target="_blank"
