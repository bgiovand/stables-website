      ...
      <main className="max-w-max min-w-full md:max-w-lg">
        ...
        <section id="values" className="mb-20">
          ...
          <div className="">
            ...
            <ul className="font-light text-2xl flex flex-row">
              {certifications.map((cert) => (
                <li key={cert.name} className="mr-5 flex flex-col">
                  {/* {cert.type} */}
                  <svg
                    data-name="ISO"
            ...
            <ul className="font-light text-2xl flex flex-row">
              {equipment.map((equip) => (
                ...
                >
                  <div className="text-stablesYellow text-2xl font-semibold">
                    <Link
                      href={equip.link}
                      target="_blank"
                    ...
                    >
                      <Image
                        ...
                        height={20}
                      />
                      <span className="text-gray-100">{equip.brand}</span>
                    </Link>
                    <ul className="text-gray-100">
                      {equip.models.map((model) => (
                        <li
                          key={model}
        ...
        <section className="bg-stablesYellow p-10 pb-0 mb-20">
          ...
          <div className="flex flex-col md:flex-row">
            {team.map((member) => (
              ...
              >
                <Image
                  src={member.image ? member.image : "placeholder.png"}
                  alt={member.name}
                  width={200}
                  height={200}
                />
